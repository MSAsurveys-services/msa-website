...
export default function ServicesPage() {
  const MSA_SERVICES = [
    {
      title: "MSA Container Cargo Inspection (Dry & Reefer/Wet)",
    ...
    {
      title: "MSA Port Captain Services",
    ...
    {
      title: "MSA Draft Surveys (Loading & Unloading Operations)",
    ...
    {
      title: "MSA Tally & Superintendency Services",
    ...
    {
      title: "MSA On-Hire / Off-Hire Condition Surveys",
    ...
    {
      title: "MSA Project Cargo & Heavy Lift",
    ...
    {
      title: "MSA Pre-Shipment Inspection (PSI)",
    ...
    {
      title: "MSA Pre-Purchase Surveys",
    ...
    {
      title: "MSA Crane Reliability and Vessel Assessment",
    ...
    {
      title: "MSA Cleanliness & Hold Inspection",
    ...
    {
      title: "MSA Underwater Hull Inspection & Maintenance",
